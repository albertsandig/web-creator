...
CREATE TABLE temp_event(
    temp_no     int(200)  NOT NULL AUTO_INCREMENT,
    temp_name   varchar(200),
    PRIMARY KEY (temp_no)
);

INSERT INTO temp_event(temp_name) VALUES
('Give Away Couple Ring'),
('Give Away Mouse');


CREATE TABLE temp(
    temp_event_no    int(200)  NOT NULL ,
    temp_email       varchar(200),
    FOREIGN KEY (temp_event_no) REFERENCES temp_event(temp_no)
);
...
CREATE TABLE pages (
    page_id          int(200)  NOT NULL AUTO_INCREMENT,
    name             varchar(200) NOT NULL,
    cat_id           int(200),
    PRIMARY KEY (page_id),
